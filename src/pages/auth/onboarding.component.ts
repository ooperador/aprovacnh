      ...
      <div class="max-w-md w-full mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="space-y-6">
           <div>
             ...
             <select formControlName="uf" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary py-3 px-4">
           ...
           <div>
             ...
             <input type="date" formControlName="examDate" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary py-3 px-4">
           </div>
