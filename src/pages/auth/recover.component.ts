          ...
          @if (sent) {
            ...
            <div class="space-y-6">
              <div>
                ...
                <div class="mt-1">
                  <input [formControl]="emailControl" id="email" type="email" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary sm:text-sm bg-white text-gray-900">
                </div>
              </div>
