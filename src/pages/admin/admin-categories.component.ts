        ...
        <form [formGroup]="form" (ngSubmit)="submit()">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <input formControlName="color" type="text" placeholder="bg-blue-600" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2">
            </div>
            <div class="md:col-span-2">
               <label class="block text-sm font-medium text-gray-700">URL Imagem</label>
               <input formControlName="image" type="text" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2">
            </div>
          </div>
